...
e&&e.getTransaction()&&e.setSpan(void 0)}},43174:(t,e,n)=>{n.r(e),n.d(e,{BROWSER_TRACING_INTEGRATION_ID:()=>at,BrowserTracing:()=>rt,IdleTransaction:()=>B.io,Integrations:()=>i,Span:()=>_t.Dr,SpanStatus:()=>ct,TRACEPARENT_REGEXP:()=>D.K,Transaction:()=>dt.Y,addExtensionMethods:()=>a.ro,defaultRequestInstrumentationOptions:()=>et,extractTraceparentData:()=>D.q,getActiveTransaction:()=>k.x1,hasTracingEnabled:()=>k.zu,instrumentOutgoingRequests:()=>nt,spanStatusfromHttpCode:()=>_t.Zd,startIdleTransaction:()=>a.lb,stripUrlQueryAndFragment:()=>o.rt})
var i={}
...
var N=n(66627),D=n(75492),x=n(22850),B=n(27448),k=n(48206),G=(0,N.R)(),U=n(4549),Y=n(88468),A=n(68256),I=(t,e,n)=>{let i
...
function F(){return H&&H.addEventListener&&H.performance}let z,j,J=0,X={}
...
e&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS"),X.cls={value:t.value,unit:""},j=e)}),n,void 0),w((()=>{c.takeRecords().map(o),i(!0)})))})()}function Z(t){((t,e)=>{var n=M(),i=O("LCP")
let a
...
if(e){var n=(0,k.XL)(Y.Z1),i=(0,k.XL)(e.startTime);("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding LCP"),X.lcp={value:t.value,unit:"millisecond"},X["mark.lcp"]={value:n+i,unit:"second"},z=e}}),i,e)
...
if(e){var n=(0,k.XL)(Y.Z1),i=(0,k.XL)(e.startTime);("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FID"),X.fid={value:t.value,unit:"millisecond"},X["mark.fid"]={value:n+i,unit:"second"}}}),i,void 0),w((()=>{o.takeRecords().map(s),o.disconnect()}),!0))})()}function K(t,e,n,i,a,s){var r=s?e[s]:e[`${n}End`],o=e[`${n}Start`]
o&&r&&P(t,{op:"browser",description:(0,U.h)(a,(()=>n)),startTimestamp:i+(0,k.XL)(o),endTimestamp:i+(0,k.XL)(r)})}var V=n(98902),tt=n(8142),et={traceFetch:!0,traceXHR:!0,tracingOrigins:["localhost",/^\//]}
...
var c={}
e&&(0,tt.o)("fetch",(t=>{!function(t,e,n){if((0,k.zu)()&&t.fetchData&&e(t.fetchData.url))if(t.endTimestamp){var i=t.fetchData.__span
if(!i)return;(s=n[i])&&(t.response?s.setHttpStatus(t.response.status):t.error&&s.setStatus("internal_error"),s.finish(),delete n[i])}else{var a=(0,k.x1)()
...
if((0,_.V9)(t,Request)&&(a=t.headers),a)if("function"==typeof a.append)a.append("sentry-trace",n.toTraceparent()),a.append(x.bU,(0,x.J8)(e,a.get(x.bU)))
else if(Array.isArray(a)){const[,t]=a.find((t=>{let[e,n]=t
return e===x.bU}))
a=[...a,["sentry-trace",n.toTraceparent()],[x.bU,(0,x.J8)(e,t)]]}else a={...a,"sentry-trace":n.toTraceparent(),baggage:(0,x.J8)(e,a.baggage)}
else a={"sentry-trace":n.toTraceparent(),baggage:(0,x.J8)(e)}
return a}(r,a.getBaggage(),s,o)}}}(t,o,c)})),n&&(0,tt.o)("xhr",(t=>{!function(t,e,n){if(!(!(0,k.zu)()||t.xhr&&t.xhr.__sentry_own_request__)&&t.xhr&&t.xhr.__sentry_xhr__&&e(t.xhr.__sentry_xhr__.url)){var i=t.xhr.__sentry_xhr__
if(t.endTimestamp){var a=t.xhr.__sentry_xhr_span_id__
if(!a)return;(r=n[a])&&(r.setHttpStatus(i.status_code),r.finish(),delete n[a])}else{var s=(0,k.x1)()
...
var o=t.xhr.getRequestHeader&&t.xhr.getRequestHeader(x.bU)
t.xhr.setRequestHeader(x.bU,(0,x.J8)(s.getBaggage(),o))}catch(t){}}}}}(t,o,c)}))}var it=(0,N.R)(),at="BrowserTracing",st={idleTimeout:B.nT,finalTimeout:B.mg,markBackgroundTransactions:!0,routingInstrumentation:function(t){let e=!(arguments.length>1&&void 0!==arguments[1])||arguments[1],n=!(arguments.length>2&&void 0!==arguments[2])||arguments[2]
...
void 0===s&&a&&-1!==a.indexOf(n)?a=void 0:s!==n&&(a=void 0,i&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Tracing] Finishing current transaction with op: ${i.op}`),i.finish()),i=t({name:it.location.pathname,op:"navigation",metadata:{source:"url"}}))}))},startTransactionOnLocationChange:!0,startTransactionOnPageLoad:!0,...et}
class rt{__init(){this.name=at}constructor(t){rt.prototype.__init.call(this)
let e=et.tracingOrigins
t&&(t.tracingOrigins&&Array.isArray(t.tracingOrigins)&&0!==t.tracingOrigins.length?e=t.tracingOrigins:("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&(this._emitOptionsWarning=!0)),this.options={...st,...t,tracingOrigins:e}
const{_metricOptions:n}=this.options
!function(){let t=arguments.length>0&&void 0!==arguments[0]&&arguments[0]
var e=F()
e&&Y.Z1&&(e.mark&&H.performance.mark("sentry-tracing-init"),W(),Z(t),Q())}(n&&n._reportAllChanges)}setupOnce(t,e){this._getCurrentHub=e,this._emitOptionsWarning&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.warn("[Tracing] You need to define `tracingOrigins` in the options. Set an array of urls or patterns to trace."),("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.warn(`[Tracing] We added a reasonable default for you: ${et.tracingOrigins}`))
...
n((t=>this._createRouteTransaction(t)),a,i),s&&(G&&G.document?G.document.addEventListener("visibilitychange",(()=>{var t=(0,k.x1)()
...
var s="pageload"===t.op?function(){var t=ot("sentry-trace"),e=ot("baggage"),n=t?(0,D.q)(t):void 0,i=(0,x.rg)(e,t)
...
var n=(0,k.XL)(Y.Z1),i=e.getEntries()
let a,s
i.slice(J).forEach((e=>{var i=(0,k.XL)(e.startTime),o=(0,k.XL)(e.duration)
if(!("navigation"===t.op&&n+i<t.startTimestamp))switch(e.entryType){case"navigation":!function(t,e,n){["unloadEvent","redirect","domContentLoadedEvent","loadEvent","connect"].forEach((i=>{K(t,e,i,n)})),K(t,e,"secureConnection",n,"TLS/SSL","connectEnd"),K(t,e,"fetch",n,"cache","domainLookupStart"),K(t,e,"domainLookup",n,"DNS"),function(t,e,n){P(t,{op:"browser",description:"request",startTimestamp:n+(0,k.XL)(e.requestStart),endTimestamp:n+(0,k.XL)(e.responseEnd)}),P(t,{op:"browser",description:"response",startTimestamp:n+(0,k.XL)(e.responseStart),endTimestamp:n+(0,k.XL)(e.responseEnd)})}(t,e,n)}(t,e,n),a=n+(0,k.XL)(e.responseStart),s=n+(0,k.XL)(e.requestStart)
break
...
"first-paint"===e.name&&d&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FP"),X.fp={value:e.startTime,unit:"millisecond"},X["mark.fp"]={value:c,unit:"second"}),"first-contentful-paint"===e.name&&d&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding FCP"),X.fcp={value:e.startTime,unit:"millisecond"},X["mark.fcp"]={value:c,unit:"second"})
break
...
n&&(n.effectiveType&&t.setTag("effectiveConnectionType",n.effectiveType),n.type&&t.setTag("connectionType",n.type),q(n.rtt)&&(X["connection.rtt"]={value:n.rtt,unit:"millisecond"}),q(n.downlink)&&(X["connection.downlink"]={value:n.downlink,unit:""})),q(e.deviceMemory)&&t.setTag("deviceMemory",`${e.deviceMemory} GB`),q(e.hardwareConcurrency)&&t.setTag("hardwareConcurrency",String(e.hardwareConcurrency))}}(t),"pageload"===t.op&&("number"==typeof a&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding TTFB"),X.ttfb={value:1e3*(a-t.startTimestamp),unit:"millisecond"},"number"==typeof s&&s<=a&&(X["ttfb.requestTime"]={value:1e3*(a-s),unit:"millisecond"})),["fcp","fp","lcp"].forEach((e=>{if(X[e]&&!(n>=t.startTimestamp)){var i=X[e].value,a=n+(0,k.XL)(i),s=Math.abs(1e3*(a-t.startTimestamp)),o=s-i;("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log(`[Measurements] Normalized ${e} from ${i} to ${s} (${o})`),X[e].value=s}})),X["mark.fid"]&&X.fid&&P(t,{description:"first input delay",endTimestamp:X["mark.fid"].value+(0,k.XL)(X.fid.value),op:"web.vitals",startTimestamp:X["mark.fid"].value}),"fcp"in X||delete X.cls,Object.keys(X).forEach((e=>{t.setMeasurement(e,X[e].value,X[e].unit)})),function(t){z&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding LCP Data"),z.element&&t.setTag("lcp.element",(0,A.R)(z.element)),z.id&&t.setTag("lcp.id",z.id),z.url&&t.setTag("lcp.url",z.url.trim().slice(0,200)),t.setTag("lcp.size",z.size)),j&&j.sources&&(("undefined"==typeof __SENTRY_DEBUG__||__SENTRY_DEBUG__)&&r.kg.log("[Measurements] Adding CLS Data"),j.sources.forEach(((e,n)=>t.setTag(`cls.source.${n+1}`,(0,A.R)(e.node)))))}(t)),z=void 0,j=void 0,X={}})(t),t.setTag("sentry_reportAllChanges",Boolean(this.options._metricOptions&&this.options._metricOptions._reportAllChanges))})),l}}function ot(t){var e=(0,N.R)()
...
//# sourceMappingURL=chunk.174.eec7f6398cef4c3e2485.map