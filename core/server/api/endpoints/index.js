...
module.exports = {
    ...
    get updateFile() {
        return shared.pipeline(require('./updateFile'), localUtils);
    },
    
    get readMysql() {
        return shared.pipeline(require('./readMysql'), localUtils);
    },
    ...
    get uploadFile() {
        return shared.pipeline(require('./uploadFile'), localUtils);
    },
