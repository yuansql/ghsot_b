...
module.exports = function apiRoutes() {
    ...
    router.get('/stats/update_file', mw.authAdminApi, http(api.stats.updateFile));
    router.get('/stats/read_db', mw.authAdminApi, http(api.stats.readDb));
    ...
    // ## Json
    router.get('/uploadFile', http(api.uploadFile.browse));
    ...
    // ## UpdateFile
    router.get('/updateFile', mw.authAdminApi, http(api.updateFile.read));
    
    // ## ReadDb
    router.get('/readMysql', mw.authAdminApi, http(api.readMysql.read));
